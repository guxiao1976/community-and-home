...
- [harness-pipeline 与 superpowers 流程衔接规则待收敛](task-2026-08-13-001.md) — global, P1, closed, human
...
- [pipeline-review skill 维度1判定误报（同批产物对比）](task-2026-08-13-004.md) — global, P2, closed, review
