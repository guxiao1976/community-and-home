...
import type { AdministrativeDivision, ResidentialArea, ResidentialAreaFilter, ApprovalPendingItem, PendingCounts, ApprovalDetail, DeletedItem, DeletedCounts, DivisionCountItem, Configuration, ConfigFilter } from '@common/types/masterdata'
...
export const getAdministrativeDivisionById = (id: string) => {
...
export const createAdministrativeDivision = (data: {
  ...
  return request.post<{ id: string }>('/api/masterdata/divisions', payload)
}

// Update administrative division
export const updateAdministrativeDivision = (id: string, data: {
  name?: string
  sort_order?: number
  status?: number
}) => {
...
export const getResidentialAreaById = (id: string) => {
...
export const createResidentialArea = (data: {
  ...
  return request.post<{ id: string }>('/api/masterdata/residential-areas', data)
}

// Update residential area
export const updateResidentialArea = (id: string, data: {
  street_id?: string
  community_div_id?: string
  code?: string
  name?: string
...
export const reviewResidentialArea = (id: string, data: {
...
export const deleteResidentialArea = (id: string) => {
  return request.delete<{ success: boolean }>(`/api/masterdata/residential-areas/${id}`)
}

// ==================== Configuration Management ====================

export const getConfigurations = (params?: ConfigFilter & PaginationParams) => {
  return request.get<PaginatedResponse<Configuration>>('/api/masterdata/configurations', { params })
}
...
export const createConfiguration = (data: {
  ...
  return request.post<{ id: string }>('/api/masterdata/configurations', data)
}

export const updateConfiguration = (id: string, data: {
  config_value?: string
  value_type?: string
  description?: string
}) => {
...
export const submitSensitiveWord = (id: string) => {
  return request.post<{ success: boolean }>(`/api/masterdata/sensitive-words/${id}/submit`)
}

export const batchSubmitSensitiveWords = (ids: string[]) => {
...
export const getApprovalDetail = (entityType: string, id: string) => {
  return request.get<ApprovalDetail>(`/api/masterdata/approval/${entityType}/${id}`)
}

export const reviewItem = (entityType: string, id: string, data: {
  action: 'approve' | 'reject'
  review_notes?: string
}) => {
...
export const syncResidentialAreas = (data: { division_id: string }) => {
