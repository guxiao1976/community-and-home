...
// 获取成本统计
func GetCostStatsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetCostStatsRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := cost.NewGetCostStatsLogic(r.Context(), svcCtx)
		resp, err := l.GetCostStats(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
