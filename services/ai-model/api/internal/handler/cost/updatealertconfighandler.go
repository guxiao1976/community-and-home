...
// 更新预警配置
func UpdateAlertConfigHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cost.NewUpdateAlertConfigLogic(r.Context(), svcCtx)
		resp, err := l.UpdateAlertConfig(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
