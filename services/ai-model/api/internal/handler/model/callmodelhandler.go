...
// 调用模型
func CallModelHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ModelCallRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := model.NewCallModelLogic(r.Context(), svcCtx)
		resp, err := l.CallModel(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
