...
func BatchSubmitConfigurationsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := configuration.NewBatchSubmitConfigurationsLogic(r.Context(), svcCtx)
		resp, err := l.BatchSubmitConfigurations(&req)
		if err != nil {
