...
func GetMySubmissionRecordsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := submissionrecord.NewGetMySubmissionRecordsLogic(r.Context(), svcCtx)
		resp, err := l.GetMySubmissionRecords(&req)
